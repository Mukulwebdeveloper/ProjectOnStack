...
const Widget = () => {
  return (
    <div className="widget">
      ...
      <div className="right-sidebar-div-1">
        <div className="right-sidebar-div-2">
          <img src={message} alt="pen" width="13px" />
          <p>
        ...
        <div className="right-sidebar-div-2">
          <img src={stackoverflow} alt="stack" width="13px" />
      ...
      <div className="right-sidebar-div-1">
        ...
        <div className="right-sidebar-div-2">
          <p>20</p>
          <p> What is the best course of action when a user has a high enough re to...</p>
        </div>
        <div className="right-sidebar-div-2">
         <p>14</p>
          <p> Is a link to the " Hello to ask" help page a useful comment?</p>
        </div>
      </div>
    </div>
  );
